...
*         : 30.07.2021 1.00      First Release
*         : 24.09.2021 1.01      Fixed the macro definitions for CANFD and MTU8.
*         : 01.10.2021 1.02      Fixed the macro definitions for CANFD.
*         : 20.10.2021 1.03      Fixed the macro definitions for CANFD.
*         : 02.11.2021 1.04      Fixed the macro definitions for CMPC.
***********************************************************************************************************************/
