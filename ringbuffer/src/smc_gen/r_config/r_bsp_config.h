...
/* Whether Encryption is included or not.
   ...
   H            = 0x11            = With JTAG interface, with sub-clock oscillator,
                                    CAN FD protocol supported
*/
#define BSP_CFG_MCU_PART_FUNCTION       (0xB) /* Generated value. Do not edit this manually */
...
/* Group name.
   ...
   60           = RX660 Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX660" /* Generated value. Do not edit this manually */
